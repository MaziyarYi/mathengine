...
public class StaticFunction {
    ...
    public static final Function SIN = new Function("sin", 1) {
        ...
        public Operand function(Operand... operands) {
            return new Operand(FractionDigit.getInstance().truncate(Math.sin(Math.toRadians(operands[0].getNumber()))));
        }
    };
    ...
    public static final Function COS = new Function("cos", 1) {
        @Override
        public Operand function(Operand... operands) {
            return new Operand(FractionDigit.getInstance().truncate(Math.cos(Math.toRadians(operands[0].getNumber()))));
        }
    };
    ...
    public static final Function TAN = new Function("tan", 1) {
        @Override
        public Operand function(Operand... operands) {
            return new Operand(FractionDigit.getInstance().truncate(Math.tan(Math.toRadians(operands[0].getNumber()))));
        }
    };
    ...
    public static final Function COT = new Function("cot", 1) {
        @Override
        public Operand function(Operand... operands) {
            return new Operand(FractionDigit.getInstance().truncate(1 / Math.tan(Math.toRadians(operands[0].getNumber()))));
        }
    };
    ...
    public static final Function CSC = new Function("csc", 1) {
        @Override
        public Operand function(Operand... operands) {
            return new Operand(FractionDigit.getInstance().truncate(1 / Math.sin(Math.toRadians(operands[0].getNumber()))));
        }
    };
    ...
    public static final Function SEC = new Function("sec", 1) {
        @Override
        public Operand function(Operand... operands) {
            return new Operand(FractionDigit.getInstance().truncate(1 / Math.cos(Math.toRadians(operands[0].getNumber()))));
        }
    };
